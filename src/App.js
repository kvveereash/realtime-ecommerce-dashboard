...
const stripePromise = loadStripe("pk_test_51Ss0hjA9lbYhaCz4IHE29vKp7SHd1WrezBGqdN73t3QZq21GoUfYZ9oCvTNp6gxqj3THG1D4erHRlHjBBcarCWtR00kIYDhgZd");
    ...
    const shownotification=(tittle,body)=>{
        if(Notification.permission==="granted")
        {
           new Notification(tittle,{
            body
           })
        }
    }
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/checkout" element={ <ProtectedRoutes><Elements stripe={stripePromise}><Checkout cart={cart} setcart={setcart} shownotification={shownotification} /></Elements></ProtectedRoutes>}/>
